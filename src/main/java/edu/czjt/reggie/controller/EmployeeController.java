...
public class EmployeeController {
    ...
    @Autowired
    RedisTemplate redisTemplate;  // redis模板类，封装了redis的常见操作
    ...
    public R<Employee> login(HttpServletRequest request, @RequestBody Employee employee) {
        ...
        System.out.println("登录用户id=="+emp.getUsername()+"---"+emp.getPhone());
        redisTemplate.opsForValue().set(emp.getPhone(),emp.getName());
